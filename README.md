...
**[Hello Rails App]** A simple project to demonstrate the use of Ruby on Rails with React and Redux.
...
```
  ...
  rails db:migrate
```
run the following commands, to be able to use Bootstrap and JavsScript
